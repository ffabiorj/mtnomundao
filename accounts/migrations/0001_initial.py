    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('about', models.TextField(blank=True, verbose_name='Do que você mas gosta no conecades')),
                ('photo', models.ImageField(blank=True, null=True, upload_to='fotos', verbose_name='Foto')),
                ('is_staff', models.BooleanField(default=False, verbose_name='Ativo')),
